...
const Education: React.FC<EducationProps> = ({ darkMode }) => {
  const education = [
    ...
    {
      institution: 'St. Claret Matriculation Higher Secondary School, Thiruninravur, Tamil Nadu',
      degree: '12th Grade',
      duration: '2021 – 2022',
      cgpa: '90%',
      type: 'school'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {education.map((edu, index) => (
            <div key={index} className={`rounded-lg p-8 shadow-lg ${darkMode ? 'bg-gray-800' : 'bg-white'} transition-all duration-300 hover:shadow-xl`}>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    ...
                    <div className="flex flex-col md:items-end mt-4 md:mt-0">
                      ...
                      <div className={`px-4 py-2 rounded-full text-sm font-medium ${
                        ...
                        {edu.type === 'college' ? 'CGPA' : 'Score'}: {edu.cgpa}
                      </div>
                    </div>
                  </div>
